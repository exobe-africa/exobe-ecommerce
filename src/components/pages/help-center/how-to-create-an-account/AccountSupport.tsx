...
const AccountSupport: React.FC<AccountSupportProps> = ({
  title = "Need Help Creating Your Account?",
  description = "Our support team is ready to help you get started with your eXobe account.",
  primaryButtonText = "Get Account Help",
  secondaryButtonText = "Create Account Now",
  onPrimaryClick,
  onSecondaryClick
}) => {
