...
import { ShoppingBag, Truck, Clock, MapPin, Package, AlertCircle, MessageCircle, Phone, Mail } from 'lucide-react';
import Link from 'next/link';

const ordersArticles = [
  {
    title: 'How to track my order',
    description: 'Learn how to track your order status and get real-time updates',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Find out delivery times and areas we serve',
    icon: Clock,
  ...
  },
  {
    ...
    description: 'Steps to take when your order is delayed',
    icon: AlertCircle,
    slug: 'order-delayed',
    featured: false
  },
  {
    ...
    description: 'How to change your delivery address after placing an order',
    icon: MapPin,
    slug: 'change-delivery-address',
    featured: false
  },
  {
    title: 'Delivery fees and options',
    description: 'Understanding delivery fees and available delivery options',
    icon: Package,
    slug: 'delivery-fees-options',
    featured: false
  },
  {
    title: 'Order confirmation issues',
    description: 'Troubleshooting order confirmation problems',
    icon: ShoppingBag,
    slug: 'order-confirmation-issues',
    featured: false
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <HelpCenterHero 
        ...
        description="Everything you need to know about tracking orders, delivery information, and shipping questions."
        icon={ShoppingBag}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {ordersArticles.filter(article => article.featured).map((article) => {
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-sm opacity-90">Check order status and delivery updates</p>
            </Link>
            <Link 
            ...
            >
              ...
              <p className="text-sm opacity-90">View your order history and details</p>
            </Link>
            <Link 
              href="/return-request"
            ...
            >
              <Package className="h-8 w-8 mx-auto mb-3 text-[#C8102E]" />
              <h3 className="text-lg font-semibold mb-2">Return Item</h3>
              <p className="text-sm opacity-70">Start a return request</p>
            </Link>
          </div>
        </section>
